...
function DisplacementSphere() {
  ...
  useEffect(() => {
    ...
    light.current = new DirectionalLight(initialThemeRef.current ? initialThemeRef.current.colorWhite : 0xffffff, 0.6);
    ambientLight.current = new AmbientLight(initialThemeRef.current ? initialThemeRef.current.colorWhite : 0xffffff, initialThemeRef.current.id === 'light' ? 0.8 : 0.1);
    ...
    scene.current.background = new Color(initialThemeRef.colorBackground ? initialThemeRef.current.colorBackground : 0x111111);
  ...
  useEffect(() => {
    light.current = new DirectionalLight(currentTheme ? currentTheme.colorWhite : 0xffffff, 0.6);
    ambientLight.current = new AmbientLight(currentTheme ? currentTheme.colorWhite : 0xffffff, currentTheme.id === 'light' ? 0.8 : 0.1);
