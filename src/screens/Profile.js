...
const ProfileText = ({ status, titleId }) => (
  <Fragment>
    ...
    <ProfileDescription status={status}>
      I did my middle schooling (ICSE or 10th standard) at <Anchor href="https://www.dbbandel.org/" target="_blank">Don Bosco School, Bandel</Anchor> and my high schooling (ISC or 12th Standard) at <Anchor href="http://nopanyhigh.com/" target="_blank">Nopany High, Kolkata.</Anchor>
    </ProfileDescription>
    <ProfileDescription status={status}>
