...
const ProjectItemImageLaptop = styled(ProgressiveVideo)`
  width: 862px;
  height: 531px;
  transition-property: transform, opacity;
...
const ProjectItemPhoneFrame = styled(ProgressiveVideo)`
  position: absolute;
  width: 414px;
  height: 721px;
...
const ProjectItemPhoneImage = styled(ProgressiveVideo)`
...
export default React.memo(ProjectItem2);
